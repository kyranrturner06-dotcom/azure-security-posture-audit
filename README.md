...
This is a simple fix, I navigated to 'Network settings' in the VM, and under 'Inbound port rules' selected the RDP port rule and changed 'Source' from 'Any' to 'My IP address'. This removed the warning mark as now the VM isn't accessible to the entire internet. It is only accessible from my IP. Refer to Image 4.
